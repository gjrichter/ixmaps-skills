...
```html
<div id="sidebar_div">
  <!-- optional: title, counter chips, active-filter banner -->
  <div id="stats-bar">
    <span>Total: <b id="count-total">—</b></span>
    <span>In view: <b id="count-visible">—</b></span>
  </div>
  <div id="filter-div" style="display:none">
    <b>Active filter:</b> <span id="filter"></span>
    <button onclick="clearFilter()">✕ remove</button>
  </div>

  <!-- scrollable facet area -->
  <div id="scroll-area" style="overflow-y:auto; flex:1">
